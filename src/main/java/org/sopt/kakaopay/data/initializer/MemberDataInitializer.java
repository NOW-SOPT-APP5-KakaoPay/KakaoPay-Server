...
public class MemberDataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        Member[] members = new Member[] {
                ...
                Member.create("user2", "양대한", "8,000", "10,000","카카오", "000123456789", "30,047,500"),
                Member.create("user3", "김도훈", "15,000", "30,000","카카오", "3333054449335", "50,000,500"),
                Member.create("user4", "박세은", "7,000", "17,000","토스", "100033074221", "88,008,800"),
